...
from rrgoalfinder2020 import RRGoalFinder2020
...
class VisionServer2020(VisionServer):
    ...
    def __init__(self, calib_file):
        ...
        self.rrgoal_finder = RRGoalFinder2020(calib_file)
        self.add_target_finder(self.rrgoal_finder)
    ...
    def update_parameters(self):
        ...
        self.rrgoal_finder.set_color_thresholds(self.rrtarget_hue_low_limit, self.rrtarget_hue_high_limit,
